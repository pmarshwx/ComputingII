...
```{r}
mileagedata <- read.table("gasoline.data",header = TRUE,stringsAsFactors = TRUE)
duckframe <- read.table(header=TRUE,stringsAsFactors = TRUE, text="
...
```{r}
plot(ppg~station, data=mileagedata, ylab = "Price ($/gallon)")
```
